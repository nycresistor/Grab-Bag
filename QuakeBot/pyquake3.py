...
class Player:
    def __init__(self, name, frags, ping, address=None, bot=-1, num=None):
        self.name = name
        self.frags = frags
        self.ping = ping
...
class PyQuake3:
    ...
    def rcon_update(self):
        ...
        for p in players:
            ...
            self.players.append(Player(p[3][:-2], p[1], p[2], p[5], p[6], p[0]))
            self.playersIndexed[p[0]] = Player(p[3][:-2], p[1], p[2], p[5], p[6], p[0])
